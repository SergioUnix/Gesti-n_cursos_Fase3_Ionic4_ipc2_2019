...
class UsuariosRoutes {
    ...
    config() {
        ...
        this.router.get('/:correo/:pass', usuariosController_1.usuariosController.login);
        this.router.get('/auxiliar/lista/aux', usuariosController_1.usuariosController.list_auxiliar);
    }
}
