...
@Component({
  selector: 'app-evaluacion-pregunta-orde',
  templateUrl: './evaluacion-pregunta-orde.page.html',
  styleUrls: ['./evaluacion-pregunta-orde.page.scss'],
})
export class EvaluacionPreguntaOrdePage implements OnInit {
  error_messages ={
...
'opcion4':[
  {type: 'required', message: 'Opcion 4 requerido'},
  {type: 'minlength', message: 'Opcion 4 tamaño minimo de 3 caracteres'},
  {type: 'maxlength', message: ' Opcion 4 no exceda los 80 caracteres'},
],

'opcion5':[
  {type: 'required', message: 'Opcion 5 requerido'},
  {type: 'minlength', message: 'Opcion 5 tamaño minimo de 3 caracteres'},
  {type: 'maxlength', message: ' Opcion 5 no exceda los 80 caracteres'},
],
  }
    ...
    private router: Router,private formBuilder: FormBuilder,private toastCtrl: ToastController,) {
        ...
        opcion4: new FormControl('',Validators.compose([
          Validators.required,
          Validators.minLength(3),
          Validators.maxLength(80),
        ...
        opcion5: new FormControl('',Validators.compose([
          Validators.required,
          Validators.minLength(3),
          Validators.maxLength(80),
