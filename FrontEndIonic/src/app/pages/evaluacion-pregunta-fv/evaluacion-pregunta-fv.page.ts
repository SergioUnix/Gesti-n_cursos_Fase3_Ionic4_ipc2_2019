...
@Component({
  selector: 'app-evaluacion-pregunta-fv',
  templateUrl: './evaluacion-pregunta-fv.page.html',
  styleUrls: ['./evaluacion-pregunta-fv.page.scss'],
})
export class EvaluacionPreguntaFvPage implements OnInit {
  error_messages ={
